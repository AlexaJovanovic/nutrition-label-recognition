...
# intilize OCR reader with list of languages
reader = easyocr.Reader(['en', 'rs_cyrillic', 'rs_latin'])
...
class NutritionLabelModel(ABC):
    ...
    def __init__(self, preprocessor: Optional[ImagePreprocessor] = None, lang: str = "en"):
        self.preprocessor: Optional[ImagePreprocessor] = preprocessor
        self.reader: easyocr.Reader = easyocr.Reader([lang], gpu=False)
